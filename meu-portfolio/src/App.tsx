...
const PROFILE: Profile = {
  ...
  links: {
    ...
    resume: "/Currículo_Allan_Maia_Gondim_(6).pdf",
  },
};
...
const EXPERIENCE: Experience[] = [
  {
    ...
    description: "Liderança de equipe, gestão de projetos e desenvolvimento Web.",
  },
];
...
// COMPONENTES
// =============================
const Section: FC<SectionProps> = ({ id, title, icon: Icon, children }) => (
      ...
      <Card key={s.name}>
        <CardHeader className="pb-2">
          <CardTitle className="text-base flex items-center gap-2">
            <Wrench className="h-4 w-4" />{s.name}
          </CardTitle>
        </CardHeader>
        <CardContent>
...
const Experience: FC = () => (
  <div className="grid md:grid-cols-2 gap-6">
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2">
          <Briefcase className="h-5 w-5" /> Experiência
        </CardTitle>
      </CardHeader>
      <CardContent>
        {EXPERIENCE.map((e) => (
    ...
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2">
          <GraduationCap className="h-5 w-5" /> Formação
        </CardTitle>
      </CardHeader>
      <CardContent>
        {EDUCATION.map((e) => (
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <Card className="md:col-span-2">
                <CardContent className="pt-6">
                  <p className="text-muted-foreground">
                    Trabalho com desenvolvimento web focado em performance, acessibilidade e experiência do usuário. 
                    Gosto de criar interfaces limpas, componentes reutilizáveis e automatizar processos.
                  </p>
                </CardContent>
              </Card>
              <Card>
